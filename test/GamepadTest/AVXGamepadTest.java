...
public class AVXGamepadTest {
    ...
    public AVXGamepadTest(Gamepad gamepad, Telemetry telemetry) {
    ...
    class RealAxes{
        ...
        private void realX(){
            ...
            if(quadrant == 1 || quadrant == 2)
                realx = GamepadUtil.scale(angle, 0.000, 180.0,  1.0, -1.0);
            if(quadrant == 3 || quadrant == 4)
                realx = GamepadUtil.scale(angle, 180.0, 360.0, -1.0,  1.0);
        ...
        private void realY(){
            Double realy = 0.0;
            if(quadrant == 1)
                realy = GamepadUtil.scale(angle, 0.000, 90.00,  0.0,  1.0);
            if(quadrant == 2 || quadrant == 3)
                realy = GamepadUtil.scale(angle, 90.00, 270.0,  1.0, -1.0);
            if(quadrant == 4)
                realy = GamepadUtil.scale(angle, 270.0, 360.0, -1.0,  0.0);
